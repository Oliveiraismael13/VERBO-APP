...
export const coopMissionSessions = sqliteTable("coop_mission_sessions", {
  ...
  journeyMode: text("journey_mode", { enum: ["whole", "custom"] }).notNull().default("whole"),
  startBookSlug: text("start_book_slug").notNull().default("gen"),
  startChapter: integer("start_chapter").notNull().default(1),
  endBookSlug: text("end_book_slug").notNull().default("apo"),
  endChapter: integer("end_chapter").notNull().default(22),
  currentBookSlug: text("current_book_slug").notNull().default("gen"),
