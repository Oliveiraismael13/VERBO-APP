...
type SocialNotification = { id: number; kind: "friend_request" | "friend_accepted" | "reaction" | "social_activity"; createdAt: number; read: boolean; actor: SocialContact; activityId?: number; activityTitle?: string };
